...
public class ShareAndReferController {
    ...
    @PostMapping(value = "redeem/referCode")
    public ResponseEntity redeemReferCode(@RequestBody ShareAndReferRequest shareAndReferRequest) {
        return new ResponseEntity(
                shareAndReferService.redeemRefer(shareAndReferRequest), HttpStatus.OK);
    }
}
