...
@Component
public class S2SEventHandlerProcessor  implements ItemProcessor<EventHandler, EventRequest> {

    private static final Logger log = LoggerFactory.getLogger(S2SEventHandlerProcessor.class);
